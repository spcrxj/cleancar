...
layer.ready(function() {
    ...
    if (screen.width > 768) {
        parent.layer.open({
            ...
            type: 1,
            area: ["700px", "auto"],
            content: '<img src="http://cdn.admui.com/site/img/screenshot-4.jpg" width="700" height="360">',
            btn: ["Admui官网", "关闭"],
            yes: function(d, c) {
                parent.window.location.href = "http://www.admui.com/?form=hplus"
            }
        })
    }
