...
class MicroPay
{
	...
	function __construct() {
        ...
        $this->WxPayConfig->APPID = C('WxPayConf.APPID');
		$this->WxPayConfig->MCHID = C('WxPayConf.MCHID');
		$this->WxPayConfig->KEY = C('WxPayConf.KEY');
		$this->WxPayConfig->APPSECRET = C('WxPayConf.APPSECRET');
		$this->WxPayConfig->SSLCERT_PATH = C('WxPayConf.SSLCERT_PATH');
		$this->WxPayConfig->SSLKEY_PATH = C('WxPayConf.SSLKEY_PATH');
    }
	/**
	 * 
	 * 提交刷卡支付，并且确认结果，接口比较慢
