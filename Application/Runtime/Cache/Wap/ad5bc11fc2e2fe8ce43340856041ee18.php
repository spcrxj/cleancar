...
<html>
    ...
    <body style="display: none;">
        <div class="box">
            ...
            <form  method="post" class="form-horizontal" action="<?php echo U('login/forget_password');?>" onsubmit="return check()">
                <div class="huiyuandenglu">
                    ...
                    <!--javascrtpt:window.location.href = '<?php echo U('user/set_password');?>'-->
